...
## Tools Used
SQL (SQLite via DB Browser), Tableau Public, Kaggle Sample Superstore dataset
...
5. Built an interactive dashboard to visualize the findings
...
View the live Tableau dashboard here: [Retail Profitability Analysis](https://public.tableau.com/app/profile/shoba.rathore/viz/RetailProfitabilityAnalysis_17901469383950/RetailProfitabilityAnalysis)
...
- Track discount-vs-profit trends by sub-category going forward using the dashboard
